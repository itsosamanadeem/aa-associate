...
class AccountMove(models.Model):
    ...
    @api.depends('professional_fees', 'lenght_of_classes', 'service_fee', 'product_id','per_class_fee')
    ...
    @api.onchange('professional_fees', 'lenght_of_classes', 'service_fee', 'product_id','per_class_fee')
